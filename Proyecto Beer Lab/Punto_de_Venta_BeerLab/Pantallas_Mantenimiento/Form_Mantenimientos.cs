...
namespace Punto_de_Venta_BeerLab.UI
{
    public partial class Form_Mantenimientos : Form
    {
        ...
        private void AccDireccion_Click(object sender, EventArgs e)
        {
            this.Dispose();
            Pantallas_Mantenimiento.Frm_Mantenimiento_Direcciones WindowView = new Pantallas_Mantenimiento.Frm_Mantenimiento_Direcciones(bl);
            WindowView.Show();
        }
    }
}
